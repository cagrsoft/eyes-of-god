...
# into the ~/$ROOT_TO_PYTHON/bin directory and install
#########################################
...
curl https://www.python.org/ftp/python/3.9.1/Python-3.9.1.tgz > Python-3.9.1.tgz
...
ln -s ~/$ROOT_TO_PYTHON/bin/python3.9.1 ~/$ROOT_TO_PYTHON/bin/python
# cd ..
